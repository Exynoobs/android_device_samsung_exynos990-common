...
def OTA_Assertions(info):
  ...
  if m:
    ...
    cmd = ('assert(exynos990.verify_bootloader_min("{}") == "1" || abort("ERROR: This package requires a newer Android 11 firmware than currently installed. Please upgrade firmware and retry!"););').format(bootloader_version)
